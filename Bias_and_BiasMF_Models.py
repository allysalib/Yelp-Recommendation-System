...
data = '/scratch/as12453/restaurants_subset_base.json/part-00000-7a29b2b1-535e-4142-8deb-379650ca6498-c000.json'
...
df = pd.read_json(data, lines=True, orient = 'columns')
